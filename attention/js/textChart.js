...
TextChart = class TextChartClass {
   ...
   *   2-uple [word, weight]. It can have, optionally, a third element with
  ...
  */
  draw(containerId) {
    ...
    var opacityScale = this.getOpacityScale();
  ...
  buildTexts() {
    ...
    this.line = 0;
    this.xPosition = 0;
    this.paragraph = this.words[0][2] || 0;  // First paragraph
